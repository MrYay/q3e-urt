...
static void R_Register( void )
{
	...
	r_mapOverBrightBits = ri.Cvar_Get( "r_mapOverBrightBits", "2", CVAR_ARCHIVE_ND | CVAR_LATCH | CVAR_PROTECTED );
	...
	r_overrideview = ri.Cvar_Get( "r_overrideview", "0", CVAR_CHEAT | CVAR_LATCH );
